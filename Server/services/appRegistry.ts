...
AppRegistry.register({
  ...
  features: [],
  meta: { plannedStart: "After Phase 2 Community V1.1" },
});
...
AppRegistry.register({
  ...
  frontendPath: "/ai",
  dependencies: ["core"],
  features: ["claude-sdk", "analytics-insights", "ai-recommendations"],
  meta: { sdkInstalled: true, implementationStarted: false },
});
...
AppRegistry.register({
  ...
  frontendPath: "/developers",
  dependencies: ["core", "community", "academy", "market", "work"],
  features: [],
  meta: { trigger: "When platform becomes infrastructure" },
});
