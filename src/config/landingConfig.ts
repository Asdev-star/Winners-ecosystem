...
export const defaultConfig: LandingPageConfig = {
  ...
  platforms: {
    ...
    items: [
      ...
      },
      {
        ...
        status: "live",
        pct: 100,
        desc: "Fully operational AI orchestration. OMEGA, ARIA, NOVA, SAGE, and all supervisors are live, streaming, and integrated across the ecosystem.",
        tags: [
          "9 Supervisors",
          "OMEGA Dashboard",
          "Streaming AI",
      ...
      },
      {
        ...
        status: "live",
        pct: 100,
        desc: "Freelance marketplace. Job board, freelancer profiles, applications, contracts, and AI-powered CIRCUIT matching — now live with escrow and workflow support.",
      ...
      },
      {
        ...
        status: "live",
        pct: 100,
        desc: "Complete AI-native iPaaS infrastructure. API keys, connector marketplace, webhook subscriptions, automations, AI agents builder, and DNS management — fully programmable ecosystem for developers and enterprises.",
      ...
      },
      {
        ...
        status: "live",
        pct: 100,
        desc: "Universal multimodal AI service complete. FastAPI + Ollama (Llama 3.1, DeepSeek, Qwen), faster-whisper offline STT, ComfyUI image generation, and HERALD AI orchestration — production-ready with credit-based billing.",
      ...
      },
      {
        ...
        status: "live",
        pct: 100,
        desc: "React Native super app complete — community, learning, commerce, and all 9 AI supervisors in one mobile experience with push notifications and offline AI.",
        tags: [
          "React Native",
          "Push Notifications",
          "Offline AI",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Core Engine (92%) — auth, billing, analytics, 2FA, RBAC, 52 API routes live. Community (80%) — social feed, groups, DMs, live spaces, creator studio, skill endorsements, NOVA AI live. Academy (72%) — courses, instructor dashboard, learning paths, study groups, live sessions, certificates, SAGE AI tutor live. Intelligence (100%) — all 9 AI supervisors streaming live and fully integrated across the ecosystem. Market (100%) — vendor stores, cart, orders, dropshipping live with multi-vendor commerce and ATLAS AI intelligence. Work (35%) — job board, freelancer profiles, applications built. Cloud (40%) — API keys, connectors, webhooks built. AI Platform (60%) — FastAPI multimodal service containerised.",
      },
      {
  ...
  footer: {
    ...
    ecosystemLinks: [
      ...
      { label: "Phase 6 — Work 📋", href: "#" },
      { label: "Phase 7 — Mobile ✅", href: "#" },
      { label: "Phase 8 — Cloud ✅", href: "#" },
      { label: "Phase 9 — AI Platform ✅", href: "#" },
    ],
    socialLinks: {
