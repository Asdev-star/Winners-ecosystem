...
const CSS = `
  ...
  .bp-current { background: linear-gradient(135deg, var(--surface2), var(--surface)); border: 1px solid rgba(201,168,76,0.2); border-radius: 16px; padding: 20px 24px; margin-bottom: 28px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 16px; position: relative; overflow: hidden; }
  ...
  .bp-usage-card { background: linear-gradient(135deg, var(--surface2), var(--bg)); border: 1px solid rgba(137,196,225,0.1); border-radius: 12px; padding: 16px 18px; }
  ...
  .bp-plan  { background: linear-gradient(135deg, var(--surface2), var(--bg)); border: 1px solid rgba(137,196,225,0.1); border-radius: 16px; padding: 24px; position: relative; overflow: hidden; transition: transform 0.2s, border-color 0.2s; }
  ...
  .bp-btn.gold:hover:not(:disabled) { background: var(--ice); transform: translateY(-1px); }
