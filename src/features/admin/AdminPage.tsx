...
const css = `
  ...
  .adm-header {
    ...
    border: 1px solid rgba(240,180,41,0.22); border-radius: 10px;
  ...
  .adm-header::after {
    ...
    font-family: 'Space Mono', monospace; font-size: 64px; font-weight: 700; letter-spacing: -2px;
  ...
  .adm-badge { font-family: 'Space Mono', monospace; font-size: 7px; padding: 3px 10px; border-radius: 3px; background: rgba(224,90,78,0.12); color: var(--red); border: 1px solid rgba(224,90,78,0.25); letter-spacing: 2px; }
  .adm-badge-live { font-family: 'Space Mono', monospace; font-size: 7px; padding: 3px 10px; border-radius: 3px; background: rgba(45,212,160,0.1); color: var(--green); border: 1px solid rgba(45,212,160,0.25); letter-spacing: 2px; display: flex; align-items: center; gap: 5px; animation: adm-pulse 2.5s infinite; }
  ...
  .adm-sys-time { font-family: 'Space Mono', monospace; font-size: 10px; color: var(--gold); }
  .adm-sys-user { font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim); }

  /* ── Platform Status Bar ── */
  .adm-status-bar {
    display: flex; align-items: center; gap: 6px; flex-wrap: wrap;
    padding: 10px 18px; margin-bottom: 20px;
    background: rgba(8,14,26,0.5); border: 1px solid var(--border); border-radius: 8px;
  }
  .adm-status-label { font-family: 'Space Mono', monospace; font-size: 8px; letter-spacing: 2px; text-transform: uppercase; color: var(--text-dim); margin-right: 6px; flex-shrink: 0; }
  .adm-status-chip { font-family: 'Space Mono', monospace; font-size: 8px; padding: 2px 10px; border-radius: 10px; border: 1px solid var(--border); color: var(--text-dim); display: flex; align-items: center; gap: 5px; }
  ...
  .adm-tab {
    padding: 11px 20px; font-family: 'Space Mono', monospace; font-size: 10px;
  ...
  .adm-kpi-sub   { font-family: 'Space Mono', monospace; font-size: 8px; color: var(--text-dim); margin-top: 5px; }

  /* ── Charts ── */
  .adm-charts { display: grid; grid-template-columns: 1.4fr 1fr; gap: 14px; margin-bottom: 20px; }
  .adm-chart-card { background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 20px; }
  .adm-chart-title { font-size: 12px; font-weight: 700; margin-bottom: 16px; display: flex; align-items: center; gap: 8px; }
  .adm-chart-sub { font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim); margin-left: auto; }
  ...
  .adm-plan-bar-label { display: flex; justify-content: space-between; font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim); margin-bottom: 5px; }
  ...
  .adm-plat-stat { font-family: 'Space Mono', monospace; font-size: 7px; padding: 2px 7px; border-radius: 8px; letter-spacing: 1px; }
  ...
  .adm-platform-desc { font-family: 'Space Mono', monospace; font-size: 8px; color: var(--text-dim); line-height: 1.6; }
  .adm-platform-foot { font-family: 'Space Mono', monospace; font-size: 8px; color: var(--text-dim); margin-top: 12px; padding-top: 10px; border-top: 1px solid var(--border); display: flex; justify-content: space-between; }
  ...
  .adm-ai-stat { font-family: 'Space Mono', monospace; font-size: 7px; padding: 2px 8px; border-radius: 8px; }
  ...
  .adm-ai-role  { font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim); margin-bottom: 4px; }
  .adm-ai-model { font-family: 'Space Mono', monospace; font-size: 8px; color: var(--ice); margin-bottom: 10px; }
  ...
  .adm-ai-calls { font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim); display: flex; justify-content: space-between; align-items: center; }
  ...
  .adm-dir-card { background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 20px; }
  ...
  .adm-dir-textarea {
    ...
    padding: 12px 14px; font-family: 'Space Mono', monospace; font-size: 11px; color: var(--text);
  ...
  .adm-dir-select {
    ...
    padding: 8px 12px; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--text); outline: none;
  }
  .adm-qa-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
  .adm-qa-btn {
    padding: 14px; background: var(--surface2); border: 1px solid var(--border); border-radius: 8px;
  ...
  /* ── Table ── */
  .adm-table-wrap { background: var(--surface); border: 1px solid var(--border); border-radius: 8px; overflow: hidden; margin-bottom: 14px; }
  ...
  .adm-search {
    ...
    padding: 7px 14px; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--text);
  ...
  th {
    font-family: 'Space Mono', monospace; font-size: 8px; letter-spacing: 1.5px; text-transform: uppercase;
  ...
  .adm-plan-tag { font-family: 'Space Mono', monospace; font-size: 8px; padding: 2px 8px; border-radius: 3px; }
  ...
  .adm-pagination {
    ...
    padding: 12px 20px; font-family: 'Space Mono', monospace; font-size: 9px;
    color: var(--text-dim); border-top: 1px solid var(--border);
  }
  .adm-page-btn {
    background: var(--surface2); border: 1px solid var(--border); border-radius: 4px;
    padding: 5px 14px; font-family: 'Space Mono', monospace; font-size: 9px;
  ...
  .adm-modal { background: var(--surface); border: 1px solid rgba(240,180,41,0.22); border-radius: 10px; padding: 28px; width: 380px; box-shadow: 0 24px 80px rgba(0,0,0,0.5); }
  .adm-modal-title { font-size: 15px; font-weight: 800; margin-bottom: 16px; }
  .adm-modal-select {
    width: 100%; background: var(--surface2); border: 1px solid var(--border); border-radius: 6px;
    padding: 10px 14px; font-family: 'Space Mono', monospace; font-size: 11px; color: var(--text);
    outline: none; margin-bottom: 16px;
  }
  .adm-modal-select:focus { border-color: var(--gold); }
  .adm-modal-btns { display: flex; gap: 8px; justify-content: flex-end; }
  .adm-btn { background: var(--gold); color: var(--bg); border: none; border-radius: 6px; padding: 9px 22px; font-family: 'Syne', sans-serif; font-size: 12px; font-weight: 700; cursor: pointer; transition: all 0.15s; }
  ...
  /* ── States ── */
  .adm-empty   { padding: 40px; text-align: center; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--text-dim); }
  .adm-loading { padding: 48px; text-align: center; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--text-dim); }
  .adm-error   { padding: 12px 16px; background: rgba(224,90,78,0.08); border: 1px solid rgba(224,90,78,0.2); border-radius: 6px; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--red); margin-bottom: 16px; }
  .adm-success { padding: 12px 16px; background: rgba(45,212,160,0.06); border: 1px solid rgba(45,212,160,0.18); border-radius: 6px; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--green); margin-bottom: 16px; }
