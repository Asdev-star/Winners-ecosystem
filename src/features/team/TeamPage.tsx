...
const s: Record<string, React.CSSProperties> = {
  ...
  inviteBtn: { padding: "10px 18px", background: "var(--gold)", border: "none", borderRadius: "6px", color: "var(--bg)", fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "13px", cursor: "pointer", whiteSpace: "nowrap" },
  ...
  avatar: { width: "36px", height: "36px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Space Mono, monospace", fontSize: "11px", fontWeight: 700, color: "var(--text)", flexShrink: 0 },
