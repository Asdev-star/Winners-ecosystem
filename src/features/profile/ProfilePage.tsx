  ...
  const platformAccess = [
    {
      ...
      icon: "⬡",
      status: "live",
      desc: "Dashboard, Analytics, Billing, Team",
    },
    {
      name: "Winners Community",
      icon: "🧑‍🤝‍🧑",
      status: "live",
      desc: "Feed, Posts, Groups, Chat",
    },
    {
    ...
    },
    {
      ...
      icon: "🛒",
      status: "live",
      desc: "Products, Vendors, Commerce",
    },
    {
      name: "Winners Intelligence",
      icon: "🤖",
      status: "live",
      desc: "AI Agents, Smart Automation",
    },
    {
      name: "Winners Work",
      icon: "💼",
      status: "live",
      desc: "Jobs, Freelance, Escrow",
    },
  ];
  ...
  return (
    <div style={s.page}>
      ...
      <CrossLayerHandoff
        ...
        details={
          <p>
            Earn certificates from Winners Academy to enhance your reputation
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={s.heroBadges}>
              <span
                style={{
                  ...s.roleBadge,
                  color: ROLE_COLORS[profile.role] ?? "var(--text-dim)",
          ...
          <div style={s.card}>
            ...
            <div style={{ padding: "20px" }}>
              ...
              <div style={s.skillsWrap}>
                {(editing ? form.skills : (profile.skills ?? []))?.map(
                  (skill) => (
                ...
                <>
                  <div style={s.skillInputRow}>
                    ...
                    <button
                      style={s.addSkillBtn}
                      onClick={() =>
                        skillInput.trim() && addSkill(skillInput.trim())
                      }
                    >
                      Add
                    </button>
      ...
      {tab === "ecosystem" && (
        <div style={s.card}>
          ...
          <div style={{ padding: "20px" }}>
            ...
            >
              One account. One identity. Access to all 6 platform layers as they
              go live.
            </p>
...
const s: Record<string, React.CSSProperties> = {
  ...
  heroBorder: {
    ...
    height: "2px",
    background:
      "linear-gradient(90deg, var(--gold), var(--ice), var(--purple))",
  },
  heroInner: {
    display: "flex",
  ...
  savedToast: {
    ...
    borderTop: "1px solid rgba(45,212,160,0.2)",
    color: "var(--green)",
    fontFamily: "Space Mono, monospace",
    fontSize: "10px",
    padding: "8px 24px",
