...
const s: Record<string, React.CSSProperties> = {
  ...
  avatar: { width: "72px", height: "72px", borderRadius: "50%", background: "linear-gradient(135deg, var(--gold), var(--blue))", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Space Mono, monospace", fontSize: "22px", fontWeight: 700, color: "#fff", flexShrink: 0 },
  ...
  saveBtn: { padding: "9px 18px", background: "var(--gold)", border: "none", borderRadius: "6px", color: "#0D1520", fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "13px", cursor: "pointer", whiteSpace: "nowrap", display: "block", marginBottom: "6px" },
  ...
  copyBtn: { padding: "7px 16px", background: "var(--gold)", border: "none", borderRadius: "5px", color: "#0D1520", fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "12px", cursor: "pointer" },
