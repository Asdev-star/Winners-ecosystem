...
const VERTICALS = [
  {
    ...
    revenue: [
      "10–20% transaction commission",
      "Vendor subscriptions $15–$49/mo",
    ...
    features: [
      ...
      "Printful / Gelato / AliExpress integration",
  ...
  },
  {
    ...
    revenue: [
      "Marketing package sales 20% cut",
      "Subscription tools $29–$99/mo",
      "Ad budget management fee 5–10%",
      "White-label marketing tools",
    ],
    features: [
      "Service marketplace for marketing agencies",
      "Ad campaign builder (Meta, Google, TikTok)",
  ...
  },
  {
    ...
    revenue: [
      "Channel subscription 15% cut",
      "Pay-per-view event fees",
      "Super Chat / tipping 10% cut",
      "Ad revenue sharing",
      "VOD rental & purchase commission",
    ],
    features: [
  ...
  },
  {
    ...
    revenue: [
      "Trading course subscriptions",
      "Premium signals $49–$149/mo",
      "Copy trading fee 10–20%",
      "Data provider API resale",
  ...
  },
  {
    ...
    revenue: [
      "Business plan generation credits",
      "Premium plan templates $29–$99",
      "Investor pitch review service",
      "Legal template subscriptions",
      "Launch kit bundles $49–$199",
    ],
    features: [
      "AI business plan generator (full document)",
      "Market size & competitor analysis",
      "Financial projection builder",
      "Pitch deck slide generator",
      "Legal templates (NDA, contracts, MOUs)",
      "Brand name & domain checker",
      "Revenue model calculator",
      "Startup cost estimator",
      "Investor-ready export (PDF, PPTX, DOCX)",
    ],
    status: "live",
    phase: "4E",
  ...
  },
  {
    ...
    revenue: [
      ...
      "Career coach service marketplace",
      "LinkedIn optimization service",
      "Bulk CV builder for agencies",
    ],
    features: [
      "AI CV generator (15+ professional templates)",
  ...
  },
  {
    ...
    revenue: [
      ...
      "Investment deal flow fees",
      "Premium listing placement",
    ],
    features: [
      "Property listings (buy/rent/invest)",
  ...
  },
  {
    ...
    revenue: [
      "Ticket sales 5–10% commission",
      "Event creation subscription",
      "Premium event features",
      "Sponsorship marketplace",
      "NFT ticket minting fees",
    ],
    features: [
  ...
  },
  {
    ...
    revenue: [
      "Coach program sales 20% cut",
      "Wellness subscription plans",
      "Telehealth booking commission",
      "Supplement referral sales",
      "Corporate wellness packages",
    ],
    features: [
      "Coach marketplace (fitness, nutrition, mental health)",
  ...
  },
  {
    ...
    revenue: [
      ...
      "Savings pool management fee",
      "Micro-loan interest 5–15%",
      "BNPL service fee",
      "Financial product referrals",
    ],
    features: [
      "Group savings (chama/investment clubs)",
      "Cross-border payments (M-Pesa, Flutterwave)",
      "Micro-investment pools",
      "Buy-now-pay-later for ecosystem",
      "Budget tracker + financial goals",
      "Financial literacy courses",
      "Credit score builder",
      "Insurance marketplace",
      "Remittance optimization engine",
    ],
    status: "live",
    phase: "4J",
    path: "/market/finance",
    ...
    >
      ...
      <div
        style={{
          height: 1,
          flex: 1,
          background: `linear-gradient(90deg,transparent,${T.faint})`,
        }}
      />
    </div>
  );
  ...
  const toolFields: Record<AiToolKey, ToolField[]> = {
    "Business Plan Generator": [
      {
        ...
        label: "Business Idea",
        placeholder:
          "e.g. Online tutoring platform for STEM subjects in East Africa",
      },
      {
        key: "market",
        label: "Target Market",
        placeholder: "e.g. Students aged 13–22 in Kenya, Uganda, Tanzania",
      },
      {
        key: "budget",
      ...
      },
      {
        ...
        placeholder: "e.g. Subscription, marketplace commission, freemium",
      },
    ],
    "CV Generator": [
      { key: "name", label: "Full Name", placeholder: "Your full name" },
      {
        ...
        label: "Target Role",
        placeholder:
          "e.g. Software Engineer, Product Manager, Digital Marketer",
      },
      {
        key: "experience",
        label: "Work Experience Summary",
        placeholder: "e.g. 3 years in web development, built 5 production apps",
      },
      {
        key: "skills",
        label: "Key Skills",
        placeholder: "e.g. React, Node.js, Python, leadership, Figma",
      },
      {
        key: "education",
        label: "Education",
    ...
    "Marketing Strategy": [
      ...
      },
      {
        ...
        placeholder: "e.g. Instagram, TikTok, WhatsApp, Email",
      },
    ],
    "Pitch Deck Outline": [
      {
        key: "idea",
        label: "Startup Name & Idea",
        placeholder: "What does your startup do in one line?",
      },
      {
        key: "stage",
        label: "Funding Stage",
      ...
      { key: "budget", label: "Amount Raising", placeholder: "e.g. $500,000" },
      {
        ...
        placeholder: "e.g. 1,000 users, $10K MRR, 3 pilot customers",
      },
    ],
  };
    ...
    <>
      ...
      >
        ...
        >
          <div
            style={{
              position: "absolute",
              inset: 0,
              backgroundImage: `linear-gradient(rgba(43,95,142,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(43,95,142,0.025) 1px,transparent 1px)`,
          ...
          <div
            style={{
              ...
              height: 400,
              background:
                "radial-gradient(ellipse,rgba(43,95,142,0.12),transparent 70%)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            Winners Market is 10 verticals in one platform. Commerce, digital
            marketing, streaming, trading, business tools, career tools, real
            estate, events, health, and fintech — all under one identity, one
            billing system, one AI core.
          </p>
          ...
          >
            {[
              "10 Market Verticals",
              "$0 → Revenue Day 1 possible",
              "AI-Powered Every Layer",
              "African Market First",
              "One Identity. All Markets",
            ].map((s) => (
              <span
                key={s}
                style={{
        ...
        >
            ...
            >
              {VERTICALS.map((vrt) => (
                <VerticalCard
                  ...
                  onClick={() =>
                    setActiveVertical(activeVertical === vrt.id ? null : vrt.id)
                  }
                />
              ))}
            </div>
            ...
            >
              ...
              <div
                style={{
                  padding: "28px 32px",
                  borderBottom: `1px solid ${T.border}`,
                  background: `linear-gradient(135deg,rgba(23,35,53,0.8),${T.surface})`,
                }}
              >
                <div
                  style={{
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    ...
                    {v.id === "bizplan" && (
                      <button
                        onClick={() => navigate("/market/business-launcher")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "cv" && (
                      <button
                        onClick={() => navigate("/market/cv-tools")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "digitalmarketing" && (
                      <button
                        onClick={() => navigate("/market/digital-marketing")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "streaming" && (
                      <button
                        onClick={() => navigate("/market/stream")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "trading" && (
                      <button
                        onClick={() => navigate("/market/trading")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "realestate" && (
                      <button
                        onClick={() => navigate("/market/property")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "health" && (
                      <button
                        onClick={() => navigate("/market/health")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "fintech" && (
                      <button
                        onClick={() => navigate("/market/finance")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                    ...
                    {v.id === "commerce" && (
                      <button
                        onClick={() => navigate("/market/dropshipping")}
                        style={{
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 8,
                          padding: "4px 14px",
                ...
                <div>
                  ...
                  <div
                    style={{
                      marginTop: 16,
                      padding: "12px 14px",
                      background: `rgba(${v.color === T.purple ? "155,111,255" : "201,168,76"},0.05)`,
                  ...
                  >
                    ...
                    >
                      {v.id === "commerce" &&
                        "Learn in Academy → sell products here → earn revenue → AI optimizes your store"}
                      {v.id === "digitalmarketing" &&
                        "Community audience → Market your services here → grow clients → Work matches more"}
                      {v.id === "streaming" &&
                        "Community followers → become streaming subscribers → recurring creator revenue"}
                      {v.id === "trading" &&
                        "Academy trading courses → practice here → earn in real markets → build wealth"}
                      {v.id === "bizplan" &&
                        "Idea generated → Business plan here → Academy skill courses → Community launch"}
                      {v.id === "cv" &&
                        "Academy certificates → CV built here → Work matches you to jobs → earn income"}
                      {v.id === "realestate" &&
                        "Earn via ecosystem → invest in property here → build long-term wealth"}
                      {v.id === "events" &&
                        "Community audience → sell event tickets here → grow your brand → recurring income"}
                      {v.id === "health" &&
                        "Community wellness posts → sell coaching here → Academy certification → scale"}
                      {v.id === "fintech" &&
                        "Earn in all verticals → save and invest here → financial independence achieved"}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div>
            ...
            >
                ...
                {categories.slice(0, 6).map((cat) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 4,
                      padding: "7px 14px",
                      color: productCategory === cat ? T.green : T.dim,
                      fontFamily: "'Space Mono',monospace",
                      fontSize: 9,
              ...
              <button
                onClick={() => navigate("/market/vendor")}
                style={{
            ...
            {productsLoading ? (
                    ...
                    >
                      ...
                      <div style={{ padding: 14 }}>
                        ...
                        {p.vendor?.storeName && (
                          ...
                          >
                            {p.vendor.isVerified && (
                              <span style={{ color: T.green, fontSize: 9 }}>
                                ✓
                              </span>
                            )}
                            {p.vendor.storeName}
              ...
              >
                ...
                <div style={{ fontSize: 13, color: T.dim, marginBottom: 20 }}>
                  Be the first vendor to list products in Winners Market.
                </div>
                <button
                  onClick={() => navigate("/market/vendor")}
                  style={{
          ...
          <div>
            ...
            {activeTool && (
              ...
              >
                ...
                >
                  <div
                    style={{ fontSize: 15, fontWeight: 800, marginBottom: 3 }}
                  >
                    {activeTool}
                  </div>
                  <div
                ...
                >
                  ...
                  <button
                    ...
                    disabled={streaming}
                    style={{
                      background: streaming ? T.faint : T.gold,
                      color: T.bg,
                      border: "none",
                      borderRadius: 4,
                      padding: "10px 28px",
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: "50%",
                          background: T.gold,
                          animation: streaming ? "shimmer 1s infinite" : "none",
                        }}
                      />
                      <span
                        style={{
                      ...
                      {output.split("\n").map((ln, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            style={{
                              marginBottom: isH ? 8 : 3,
                              color: isH ? T.text : T.dim,
          ...
          <div>
            ...
            >
              <div
                style={{
                  height: 2,
                  background: `linear-gradient(90deg,transparent,${T.gold},${T.green},transparent)`,
                }}
              />
                    ...
                    {[
                      {
                        phase: "4A",
                        v: "🛒 Commerce Hub",
                        rev: "10-20% commission",
                        stack: "Stripe, Printful",
                        pri: "HIGH",
                      ...
                      },
                      {
                        phase: "4B",
                        v: "📣 Digital Marketing",
                        rev: "Package sales 20%",
                        stack: "Meta API, Claude",
                        pri: "HIGH",
                        after: "Commerce live",
                      },
                      {
                        ...
                        stack: "Mux, HLS.js",
                        pri: "HIGH",
                        after: "Community stable",
                      },
                      {
                        phase: "4E",
                        v: "📋 Business Launcher",
                        rev: "Credits, templates",
                        stack: "Claude, jsPDF",
                        pri: "HIGH",
                      ...
                      },
                      {
                        phase: "4D",
                        v: "📈 Winners Trading",
                        rev: "Signals $49-149/mo",
                        stack: "Alpaca, TradingView",
                        pri: "MED",
                        after: "4B + 4C stable",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        v: "🏦 Winners Finance",
                        rev: "1-2% payments",
                        stack: "M-Pesa, Flutterwave",
                        pri: "LOW",
                        after: "Regulation ready",
                      },
                    ].map((row, i) => (
                      <tr
                        key={i}
          ...
          >
            ...
            >
              ...
              >
                COMBINED POTENTIAL ACROSS ALL 10 MARKET VERTICALS AT SCALE
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            Winners Ecosystem · Phase 4 · Winners Market · 10 Verticals ·
