...
const css = `
  ...
  .cl-admin-bar-title { font-size: 13px; font-weight: 700; margin-bottom: 14px; color: var(--gold); }

  .cl-form-row { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 10px; }
  .cl-input {
    background: rgba(137,196,225,0.04); border: 1px solid var(--border); border-radius: 8px;
    padding: 10px 13px; font-family: 'Space Mono', monospace; font-size: 12px; color: var(--text);
  ...
  .cl-textarea::placeholder { color: var(--text-faint); }

  .cl-select {
    background: rgba(137,196,225,0.04); border: 1px solid var(--border); border-radius: 8px;
    padding: 10px 13px; font-family: 'Space Mono', monospace; font-size: 11px; color: var(--text);
  ...
  .cl-cancel-btn {
    ...
    padding: 9px 16px; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--text-dim);
    cursor: pointer; transition: all 0.15s;
  }
  .cl-cancel-btn:hover { border-color: var(--ice); color: var(--ice); }

  .cl-published-label {
    font-family: 'Space Mono', monospace; font-size: 10px; color: var(--text-dim);
    display: flex; align-items: center; gap: 6px; cursor: pointer;
  }
  .cl-published-label input { accent-color: var(--gold); }
  ...
  .cl-filter:hover { border-color: rgba(201,168,76,0.3); color: var(--gold); }
  .cl-filter.active { border-color: rgba(201,168,76,0.4); background: rgba(201,168,76,0.08); color: var(--gold); }
  ...
  .cl-entry-dot.FEATURE     { background: var(--gold); box-shadow: 0 0 8px rgba(201,168,76,0.4); }
  .cl-entry-dot.BUGFIX      { background: var(--red); box-shadow: 0 0 8px rgba(248,113,113,0.3); }
  .cl-entry-dot.IMPROVEMENT { background: var(--ice); box-shadow: 0 0 8px rgba(137,196,225,0.3); }
  .cl-entry-dot.COMING_SOON { background: var(--purple); box-shadow: 0 0 8px rgba(167,139,250,0.3); }
  ...
  .cl-entry-badge.FEATURE     { background: rgba(201,168,76,0.12); color: var(--gold); border: 1px solid rgba(201,168,76,0.2); }
  .cl-entry-badge.BUGFIX      { background: rgba(248,113,113,0.12); color: var(--red); border: 1px solid rgba(248,113,113,0.2); }
  .cl-entry-badge.IMPROVEMENT { background: rgba(137,196,225,0.12); color: var(--ice); border: 1px solid rgba(137,196,225,0.2); }
  .cl-entry-badge.COMING_SOON { background: rgba(167,139,250,0.12); color: var(--purple); border: 1px solid rgba(167,139,250,0.2); }

  .cl-entry-title { font-size: 14px; font-weight: 700; flex: 1; color: var(--text); }
  .cl-entry-version {
  ...
  .cl-entry-desc { font-family: 'Space Mono', monospace; font-size: 11px; color: var(--text-dim); line-height: 1.7; margin-bottom: 12px; white-space: pre-wrap; }
  ...
  .cl-action-btn:hover { border-color: var(--ice); color: var(--ice); }
  .cl-action-btn.danger:hover { border-color: var(--red); color: var(--red); }

  .cl-unpublished { opacity: 0.55; }
  .cl-draft-tag {
    font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim);
    background: rgba(137,196,225,0.06); border: 1px solid var(--border);
  ...
  .cl-spinner { width: 24px; height: 24px; border: 2px solid rgba(201,168,76,0.15); border-top-color: var(--gold); border-radius: 50%; animation: cl-spin 0.8s linear infinite; margin: 0 auto 10px; }
  .cl-loading-text { font-family: 'Space Mono', monospace; font-size: 11px; color: var(--text-dim); }
