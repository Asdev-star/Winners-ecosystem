...
const css = `
  ...
  .ts-avatar { width: 28px; height: 28px; border-radius: 999px; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; flex-shrink: 0; background: rgba(245,200,66,0.15); color: var(--gold); }
  ...
  .ts-plan { font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim); text-transform: uppercase; letter-spacing: 1px; margin-top: 1px; }
  ...
  .ts-dropdown { position: absolute; top: calc(100% + 6px); left: 0; right: 0; background: var(--surface); border: 1px solid var(--border); border-radius: 16px; overflow: hidden; z-index: 100; animation: ts-drop 0.15s ease forwards; box-shadow: 0 8px 32px rgba(0,0,0,0.4); }
  .ts-section-label { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 2px; text-transform: uppercase; color: var(--text-dim); padding: 10px 12px 6px; border-bottom: 1px solid var(--border); }
  ...
  .ts-item-avatar { width: 26px; height: 26px; border-radius: 999px; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; flex-shrink: 0; }
  .ts-item-name  { font-size: 12px; font-weight: 600; color: var(--text); flex: 1; }
  .ts-item-plan  { font-family: 'Space Mono', monospace; font-size: 9px; color: var(--text-dim); }
  .ts-item-check { color: var(--gold); font-size: 12px; }
  .ts-divider    { height: 1px; background: var(--border); }
  .ts-action { display: flex; align-items: center; gap: 8px; padding: 10px 12px; cursor: pointer; transition: background 0.12s; font-family: 'Space Mono', monospace; font-size: 10px; color: var(--text-dim); }
