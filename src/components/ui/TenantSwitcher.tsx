...
const css = `
  ...
  .ts-avatar { width: 28px; height: 28px; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; flex-shrink: 0; background: rgba(245,200,66,0.15); color: var(--gold); }
  ...
  .ts-dropdown { position: absolute; top: calc(100% + 6px); left: 0; right: 0; background: var(--surface); border: 1px solid var(--border); border-radius: 4px; overflow: hidden; z-index: 100; animation: ts-drop 0.15s ease forwards; box-shadow: 0 8px 32px rgba(0,0,0,0.4); }
